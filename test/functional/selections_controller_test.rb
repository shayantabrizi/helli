...
class SelectionsControllerTest < ActionController::TestCase
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post :create, selection: { rank: @selection.rank, seminar_id: @selection.seminar_id, topic_id: @selection.topic_id, user_id: @selection.user_id }
    end
  ...
  test "should update selection" do
    put :update, id: @selection, selection: { rank: @selection.rank, seminar_id: @selection.seminar_id, topic_id: @selection.topic_id, user_id: @selection.user_id }
    assert_redirected_to selection_path(assigns(:selection))
  end
